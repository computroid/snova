...
class TestUtils(unittest.TestCase):
	def test_app_utils(self):
		git_url = "https://github.com/computroid/sparrow"
		branch = "develop"
	...
	def test_is_valid_sparrow_branch(self):
		with self.assertRaises(InvalidRemoteException):
			is_valid_sparrow_branch(
				"https://github.com/computroid/sparrow.git", sparrow_branch="random-branch"
			)
			is_valid_sparrow_branch(
		...
		is_valid_sparrow_branch(
			"https://github.com/computroid/sparrow.git", sparrow_branch="develop"
		)
		is_valid_sparrow_branch(
			"https://github.com/computroid/sparrow.git", sparrow_branch="v13.29.0"
		)
